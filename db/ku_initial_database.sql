...
INSERT INTO `subsites2` VALUES (166,1,'somesubsite.{{ ku_site_https_hostname }}',1,'/https_subsite/',115658,'https subsite3','',NULL,NULL,'Det Humanistiske Fakultet',4,'Kommentar','da','',NULL,NULL,NULL,1,0,0,0,'/120921.docid',21,NULL,0,'','',1),(753,45,'subsite.{{ ku_site_hostname }}',0,'/subsite/',110201,'Test af funky nav_head titel Ã† Ã˜ Ã…','','Det Natur- og Biovidenskabelige Fakultet',8,'Det Humanistiske Fakultet',5,NULL,'da','inherit this','yes',NULL,'http://english.ku.dk/',1,1,1,0,'',19,'',0,'','',12);
...
INSERT INTO `subsites_secondary_domains` VALUES (1503,753,1,'ss.{{ ku_site_hostname }}'),(1504,753,2,'testss.{{ ku_site_hostname }}');
